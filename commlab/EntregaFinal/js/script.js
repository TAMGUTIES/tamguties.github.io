alert ("Tu lugar de confort también puede ser tu lugar de angustia, tu lugar es un espacio físico y también emocional.")
...
function vista1() {
    document.getElementById('vista').src="4.png";
}
function vista2() {
    document.getElementById('vista').src="5.png";
}
